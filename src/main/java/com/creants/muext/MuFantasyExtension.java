...
import com.creants.muext.controllers.StageFinishRequestHandlerV2;
...
public class MuFantasyExtension extends QAntExtension {
	...
	private void addEventRequestHandler() {
		...
		addRequestHandler("cmd_stage_finish", StageFinishRequestHandlerV2.class);
		...
		addRequestHandler("cmd_gift_events", GiftEventRequestHandler.class);
